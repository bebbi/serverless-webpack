    ...
    return BbPromise.try(() => Packagers.get.call(this, this.configuration.packager)).then(packager => {
      ...
      return packager
        ...
        .then(dependencyGraph => {
          ...
          const emptyLockFile = path.join(compositeModulePath, 'yarn.lock');
          ...
          this.serverless.utils.writeFileSync(emptyLockFile, '');
          ...
          return BbPromise.fromCallback(cb => fse.pathExists(packageLockPath, cb))
            ...
            .mapSeries(compileStats => {
              ...
              const moduleEmptyLockFile = path.join(modulePath, 'yarn.lock');
              ...
              this.serverless.utils.writeFileSync(moduleEmptyLockFile, '');
